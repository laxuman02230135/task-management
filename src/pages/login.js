...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#0a0a23] px-4 overflow-hidden relative">
        <ParticlesBackground />
...
<div className="w-[80vw] max-w-3xl p-8 bg-[rgba(15,15,35,0.7)] backdrop-blur-xl rounded-2xl border border-[rgba(255,255,255,0.15)] shadow-2xl z-10 transition-all duration-500 hover:border-[rgba(255,255,255,0.25)] hover:shadow-[0_0_30px_rgba(230,230,250,0.15)]">
